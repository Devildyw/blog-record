...
## 1. [Eureka](https://so.csdn.net/so/search?q=Eureka&spm=1001.2101.3001.7020) Client 配置项（eureka.client.*）

> org.[springframework](https://so.csdn.net/so/search?q=springframework&spm=1001.2101.3001.7020).cloud.netflix.eureka.EurekaClientConfigBean
...
| **eureka.client.client-data-accept**                         | 客户端数据接收的名称                                         | null       |
